...
<div class='card shadow-sm mb-3 comment' id="comment_card" runat="server">
    <div class='card-body'>
    ...
    <div class="d-flex flex-column justify-content-between align-items-start text-gray-700 card-footer" id="comment_footer">
        <div class="d-flex flex-row justify-content-between align-items-center w-100" id="footer_row">
            ...
            <div class="action-block d-flex flex-row">
                <a role="button" id="collapseChildrenButton" runat="server" class="mr-5 p-0 text-gray-500 action_space collapse_children_space">
                    <i tabindex="-1" class="collapse_children action fas fa-chevron-up"></i>
                </a>
                <a role="button" id="comment_upvote_button" runat="server" class="mr-1 p-0 text-gray-500 action_space comment_upvote_space dismissable_popover"
                ...
                <a role="button" id="comment_downvote_button" runat="server" class="mr-1 p-0 text-gray-500 action_space comment_downvote_space dismissable_popover"
                    data-placement="top" data-content="you must log in to vote">
