<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="All.aspx.cs" 
Inherits="All" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="home_content" ContentPlaceHolderID="main_content" runat="Server">
        ...
        <div id="posts_space" class="d-flex flex-column w-100 py-3 px-4" style="overflow-y: scroll !important; overflow-x: hidden !important;">
